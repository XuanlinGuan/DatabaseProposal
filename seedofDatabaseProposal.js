...
async function main() {
    ...
    const comm1 =  await comment.create(false,['new driver friendly'],'09/12/2020', idPA, idUA,'The best parklot ever',5, 2000, 0);
    const comm2 = await comment.create(false,['low fee'],'07/13/2022', idPA, idUA,'very nice parking lot ',4, 1999, 1);
